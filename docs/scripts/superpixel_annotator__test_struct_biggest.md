# superpixel_annotator/test_struct_biggest.py

- Тип сценария: `legacy-cli`
- Прямой запуск: **да**
- Файл: `superpixel_annotator/test_struct_biggest.py`

## Назначение

Legacy-инструмент интерактивной аннотации с упором на крупные структуры.

## Когда использовать

Когда нужен legacy CLI для ручной/полуручной аннотации и исследования superpixel-структур.
...
```bash
python3 superpixel_annotator/test_struct_biggest.py
```
...
Traceback (most recent call last):
  File "/Users/nikitayakovlev/dev/diplom/ssn/superpixel_annotator/test_struct_biggest.py", line 51, in <module>
